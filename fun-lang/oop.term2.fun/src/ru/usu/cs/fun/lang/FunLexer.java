...
import ru.usu.cs.fun.front.MyStr;
...
public class FunLexer extends GenericLexer {
	...
	static {
		...
		Recognizer strings = new MyStr();
		Recognizer name = new FunName();
		Recognizer space = new Space();
		recognizers = new Recognizer[] { let, fun, eq, semicolon, open, close, intNumber, floatNumber,strings, name, space };
	}
